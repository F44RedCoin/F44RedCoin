...
Contains files used to package f44redcoind/f44redcoin-qt
for Debian-based Linux systems. If you compile f44redcoind/f44redcoin-qt yourself, there are some useful files here.
...
### [RPM](/contrib/rpm) ###
RPM spec file for building bf44redcoin-core on RPM based distributions.
