...
const QString BITCOIN_IPC_PREFIX("f44redcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/f44redcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/f44redcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/f44redcoin-paymentrequest";
