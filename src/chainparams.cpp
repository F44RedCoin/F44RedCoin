...
{
    const char* pszTimestamp = "SZ Times 10/Apr/2020 Die EU-Staaten werden sich dramatisch verschulden massen";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1596528789, 802508, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaed7755238f03a83f18a2f91ceb5b6c1227ed5149b1fe2250c04ae141500f4f9"));
        assert(genesis.hashMerkleRoot == uint256S("0x7dc69fadc5be44e4bff1b753729dbf2718ba02c52604ca8cadda62f2bb636a82"));

        // Note that of those with the service bits flag, most only support a subset of possible options

        vSeeds.emplace_back("dnsseed.f44redcoin.club");
        vSeeds.emplace_back("dnsseed.explorer-f44redcoin.club");
...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
         //       {0, uint256S("aed7755238f03a83f18a2f91ceb5b6c1227ed5149b1fe2250c04ae141500f4f9")},
            }
        };

        chainTxData = ChainTxData{
            // Data as of block aed7755238f03a83f18a2f91ceb5b6c1227ed5149b1fe2250c04ae141500f4f9 (height 0)
            0,
            0,
            0
        };
...
public:
    CRegTestParams() {
        ...
        consensus.nSubsidyHalvingInterval = 111;
        consensus.BIP16Height = 0; // always enforce P2SH BIP16 on regtest
