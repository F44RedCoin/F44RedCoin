...
const std::string strMessageMagic = "F44RedCoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s F44R additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("f44redcoin-scriptch");
