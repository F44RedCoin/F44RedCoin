...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s f44redcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  f44redcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded f44redcoin transaction") + "\n" +
              "  f44redcoin-tx [options] -create [commands]   " + _("Create hex-encoded f44redcoin transaction") + "\n" +
              "\n";
