F44RedCoin Core version *0.15.1* is now available from:
  ...
  <https://download.f44redcoin.org/f44redcoin-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lites per kB (0.00001 F44R). This is to prepare for dropping the minimum transaction fee to 0.1 lites per kB (0.0001 F44R) in the next release.
