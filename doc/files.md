...
* f44redcoin.conf: contains configuration settings for f44redcoind or f44redcoin-qt
* f44redcoind.pid: stores the process id of f44redcoind while running
...
* debug.log: contains debug information and general logging generated by f44redcoind or f44redcoin-qt
